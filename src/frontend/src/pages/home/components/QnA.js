  ...
  return (
    <div id="qna">
      ...
      <ul className="list-group" style={{ color: "black" }}>
        ...
        <Answer text="18 tahun" />
        <Question text="Anime yang disukai apa aja?" />
        <Answer text="One Piece, Dr. STONE, & Mushoku Tensei" />
        ...
        <Question text="Belajar Programming yang gampang dipahami dimana?" />
        <Answer text="di YouTube-nya Web Programming UNPAS sama Kelas Terbuka" />
        <Question text="Bisa ngehack ga?" />
        <Answer text="Gak.." />
        <Question text="Hack-in dong akun IG temenku soalnya ada dendam, muehehehe" />
